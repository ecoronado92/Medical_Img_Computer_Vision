...
The table below demonstrates the differences between pre- and post- class balancing using the `downSample` function. As one can observe the function under samples the majority class and makes the classes balanced (ie. same number of 0s and 1s).
