...
test_generator <- flow_images_from_data(x = X_test_reshape, 
                                        y = c(test_df[,1]),
                                         batch_size = batch_size,
                                         generator = datagen)

train_generator <- flow_images_from_data(x = X_train_reshape, 
                                        y = c(train_df[,1]),
                                         batch_size = batch_size,
                                         generator = datagen)
...
hist <- model %>% 
  fit_generator(train_generator,
                ...
                callbacks = list(early_stopping_monitor, model_checkpoint)
                )
